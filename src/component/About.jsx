...
export default function About() {
  ...
  return (
    <div className=" p-20 pb-2 pt-0 bg-white " >
      ...
      <div className="lg:grid lg:grid-cols-2  lg:mt-10 ">
        <div className=" h-3/4">
          <img
            src={profile}
            className="lg:w-3/5 lg:h-full rounded-lg lg:ml-36 md:mt-5 md:ml-32 mt-5 w-full"
          ></img>
        </div>
        <div className="mt-10 w-full lg:text-center lg:flex lg:flex-col lg:space-x-3 space-y-3 lg:mr-60 md:ml-20 place-items-start">
          <div className="md:flex space-x-2 ">
            <div className="font-bold lg:text-4xl  md:text-3xl text-xl whitespace-nowrap">
              Hello Everyone, I am
            </div>
          ...
          <div className="md:space-x-5 md:space-y-0 space-y-5 md:flex ">
            <div>
